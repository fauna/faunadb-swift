...
* If you **found a bug** or **need help** please **check older issues and [FAQ](#faq) before submitting an issue.**.
...
Follow these 3 steps to run Example project: Clone FaunaDB repository, open FaunaDB workspace and run the *Example* project.

You can also experiment and learn with the *FaunaDB Playground* which is contained in *FaunaDB.workspace*.
