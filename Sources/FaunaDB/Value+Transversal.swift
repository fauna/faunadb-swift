extension Value {
    ...
    /// Converts the value at the path informed to the desired type `T`.
    ...
    /// Converts the value at the field informed to the desired type `T`.
...
extension Value {
    ...
    /// Returns the value at the path informed.
    ...
    /// Extracts the field informed from this value.
...
extension Value {
    ...
    /// Converts the value at the path informed to an array of the desired type `T`.
    public func get<T>(_ path: Segment...) throws -> [T] {
        return try get(path: path)
    }
    ...
    /// Converts the value at the field informed to an array of the desired type `T`.
    public func get<T>(field: Field<[T]>) throws -> [T] {
        return try field.get(from: self) ?? [T]()
    }

    /// Converts each nested array element in this value using the field informed.
...
extension Value {
    ...
    /// Converts the value at the path informed to an object of `String` to the desired type `T`.
    ...
    /// Converts the value at the field informed to an object of `String` to the desired type `T`.
    public func get<T>(field: Field<[String: T]>) throws -> [String: T] {
        return try field.get(from: self) ?? [String: T]()
    }

    /// Converts each nested object element in this value using the field informed.
