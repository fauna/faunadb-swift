...
public protocol FieldType {
    ...
    func get(_ value: Value) throws -> T
    func getOptional(_ value: Value) -> T?
    func collect(_ value: Value) throws -> [T]
    func collectOptional(_ value: Value) -> [T]?
...
extension FieldType {
    public func getOptional(_ value: Value) -> T? {
        return try? get(value)
    }

    public func collectOptional(_ value: Value) -> [T]? {
     ...
     */
    public func at<U: Value>(_ other: Field<U>) -> Field<U>{
...
public struct Field<T: DecodableValue>: FieldType, ExpressibleByArrayLiteral, ExpressibleByIntegerLiteral, ExpressibleByStringLiteral where T.DecodedType == T {
    ...
    public func get(_ value: Value) throws -> T {
    ...
    public func collect(_ value: Value) throws -> [T] {
...
public struct FieldComposition {
    ...
    public static func zip<A: DecodableValue, B: DecodableValue>(field1: Field<A>, field2: Field<B>) -> ((Value)  -> (A, B)?){
        return { try? (field1.get($0), field2.get($0)) }
    }
    ...
    public static func zip<A: DecodableValue, B: DecodableValue, C: DecodableValue>(field1: Field<A>, field2: Field<B>, field3: Field<C>) -> ((Value) -> (A, B, C)?){
        return { try? (field1.get($0), field2.get($0), field3.get($0)) }
    }
    ...
    public static func zip<A: DecodableValue, B: DecodableValue, C: DecodableValue, D: DecodableValue>(field1: Field<A>, field2: Field<B>, field3: Field<C>, field4: Field<D>) -> ((Value) -> (A, B, C, D)?){
        return { try? (field1.get($0), field2.get($0), field3.get($0), field4.get($0)) }
    }
    ...
    public static func zip<A: DecodableValue, B: DecodableValue, C: DecodableValue, D: DecodableValue, E: DecodableValue>(field1: Field<A>, field2: Field<B>, field3: Field<C>, field4: Field<D>, field5: Field<E>) -> ((Value) -> (A, B, C, D, E)?){
        return { try? (field1.get($0), field2.get($0), field3.get($0), field4.get($0), field5.get($0)) }
    }
}
